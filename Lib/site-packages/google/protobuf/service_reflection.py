...
class GeneratedServiceType(type):
  ...
  Implementations for all methods described in the Services class are added here
  ...
  runtime, as in this example::
    ...
    class MyProtoService(service.Services):
...
class _ServiceBuilder(object):
  ...
  def BuildService(builder, cls):
    ...
    # CallMethod needs to operate with an instance of the Services class. This
