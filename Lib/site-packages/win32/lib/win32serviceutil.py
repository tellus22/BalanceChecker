...
class ServiceFramework:
    ...
    def SvcRun(self):
        # This is the entry point the C framework calls when the Services is
        # started. Your Services class should implement SvcDoRun().
        # Or you can override this method for more control over the Services
